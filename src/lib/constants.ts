...
siteData.logo_abs = new URL(siteData.logo, siteData.BASE_URL).toString()

export const { BASE_URL, name, short_name, description, theme_color, logo, logo_abs, keywords } = siteData
